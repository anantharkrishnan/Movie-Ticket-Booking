...
const AdminMovieDetails = () => {
  ...
  if (loading) return <div className="text-white text-xl text-center">Loading...</div>;
  if (!movie) return <div className="text-white text-xl text-center">Movie not found</div>;
           ...
           >
             ...
             <div className="relative flex gap-10 p-10">
               ...
               <div className="flex flex-col gap-5">
                 ...
                 <p className="text-gray-300">Certification:{movie.certification}</p>
