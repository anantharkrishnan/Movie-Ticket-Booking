...
const AdminComingSoonMovies = () => {
  ...
  const handleDelete = async (movieId) => {
    ...
    try {
      await axiosInstance.delete(`comingsoon/delete/${movieId}`);
    ...
    <div className="px-4 sm:px-6 md:px-10 py-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        <h1 className="text-2xl sm:text-3xl font-bold text-white">
          Admin Coming Soon Movies
        </h1>
        <button
          onClick={() => navigate("/admin/comingsoon/create")}
        ...
        {movies.map((movie) => (
          ...
          >
            ...
            <div
              ...
              onClick={() =>
                navigate(`/admin/comingsoon/details/${movie._id}`)
              }
            >
              <img
                src={movie.posterUrl}
...
export default AdminComingSoonMovies;
